...
f_all_news = '/mnt/c/Users/Second/Desktop/project/kommersant_ru.csv'
...
allheadlines, alllinks, alldates,allcategory, alldescription = [],[],[],[], []
...
def write_all_news(all_news_filepath): #функция для записи всех новостей в .csv, возвращает нам этот датасет
    header = ['Title','Links','Publication Date', 'Category', 'Description'] 
    ...
    with open(all_news_filepath, 'w', encoding='utf-8-sig') as csvfile:
        ...
        for a,b,c,d, e in zip(allheadlines,
                            alllinks, alldates,  allcategory, alldescription):
